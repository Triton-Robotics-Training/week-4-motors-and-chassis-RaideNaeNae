...
int main(){
    ...
    while(true){ //main loop
        ...
        std::cout << "power - " << testMotor.getData(POWER)
                  << " | speed - " << testMotor.getData(VELOCITY)
                  << " | position - " << testMotor.getData(ANGLE) << std::endl;
